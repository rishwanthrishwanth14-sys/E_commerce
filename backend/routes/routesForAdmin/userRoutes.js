...
router.post("/api/user/register", authenticate, isAdmin, userController.createUser);
router.post("/api/user/login", userController.loginUser);

router.get("/api/users", authenticate, isAdmin, userController.getUsers);
router.get("/api/user/profile", authenticate, isAdmin, userController.getMyProfile);
router.put("/api/user/profile", authenticate, isAdmin, userController.updateMyProfile);
